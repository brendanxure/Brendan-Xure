  ...
  return (
    <div className='max-w-[1640px] px-8 py-6 mx-auto h-full w-full' id='About'>
      <div className='md:w-[80%] lg:w-[60%] dark:text-white mx-auto text-center '>
        ...
        <p className='cursor-pointer text-xl leading-[2.5rem]  lg:text-2xl mt-8 mb-12 lg:leading-[2.5rem]'>A entry level web developer with experience in design, developement and deployment of projects. Skilled in the use of Javascript and Python. Dedicated to building and optimizing user-focused websites and applications.</p>
