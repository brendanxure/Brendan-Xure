    ...
    return (
        <div className='max-w-[1640px] p-8 mx-auto' id='Services'>
            ...
            <div className='w-[90%] md:w-[80%] lg:w-[60%] mx-auto text-xl text-center dark:text-white'>
                ...
                <p className='my-4'>I offer a wide range of services, including designing user interface, web development, web automated testing, web hosting and database architecture.</p>
            </div>
