    ...
    return (
        <div className='max-w-[1640px] p-8 mx-auto' id='Services'>
            ...
            <div className='w-[90%] md:w-[80%] lg:w-[60%] mx-auto text-xl text-center dark:text-white'>
                <p>Since the beginning of my journey as a web developer, I've done remote work for agencies and collaborated with talented software developers of different stack to create digital products for both business and consumer use.</p>
                <p className='my-4'>I offer a wide range of services, including designing user interface, web development maintenance, web hosting and web programming.</p>
            </div>
