...
const Portfolio = () => {
  ...
  return (
    <div className='max-w-[1640px] mx-auto w-full p-8' id='Portfolio'>
        ...
        <p className='text-center text-xl dark:text-white'>Here are some of my projects, you can check my <a className="text-blue-400" href='https://github.com/brendanxure?tab=repositories' target='_blank'>Github repositories </a>to get fullstack projects and more.
        </p>
